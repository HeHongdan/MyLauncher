...
public class MainActivity_ extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = View.inflate(MainActivity_.this, R.layout.main_activity, null);
        setContentView(view);
        ...
        gd = new GestureDetector(MainActivity_.this, this.gestureListener);
        ...
        lc = new LayoutCalculator(MainActivity_.this);
        pp = new ObjectPool(MainActivity_.this, lc);
        handler = new Handler();
        touchSlop = ViewConfiguration.get(MainActivity_.this).getScaledTouchSlop();
    ...
    public void loaded() {
        ...
        LinearLayout emptyView = new LinearLayout(MainActivity_.this);
        emptyView.setBackgroundDrawable(null);
        scrollView.addView(emptyView, params);
        LinearLayout emptyView2 = new LinearLayout(MainActivity_.this);
        ...
        for (int i = 0; i < pages.size(); i++) {
            SpringBoardPage page = new SpringBoardPage(MainActivity_.this);
            page.init(lc, pp);
    ...
    public void onDestroy() {
        MainActivity_.this.unregisterReceiver(receiver);
        super.onDestroy();
    }
    ...
    private void openFolder(FolderInfo folderInfo) {
        if (mFolderView == null) {
            ...
            mFolderView = folderInfo.getFolderView(MainActivity_.this);
...
//        }
    ...
    private Controller controller = new Controller() {
        ...
        public void onSynchronize() {
            Toast.makeText(MainActivity_.this, "正在同步数据", Toast.LENGTH_SHORT).show();
        }

        @Override
        public void onAppClick(ApplicationInfo app) {
            Toast.makeText(MainActivity_.this, "点击了" + app.getTitle(), Toast.LENGTH_SHORT).show();

        }

        @Override
        public void onAppRemove(ApplicationInfo app) {
            Toast.makeText(MainActivity_.this, "删除" + app.getTitle(), Toast.LENGTH_SHORT).show();
